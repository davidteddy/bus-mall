...
var display = function() {
  var listHours = document.getElementById('on-page');
  for (var i = 0; i < imageArray.length; i++){
    var listItem = document.createElement('li');
    listItem.textContent = 'Image Name - ' + imageArray[i].imgName;
    listHours.appendChild(listItem);
  };
  var total = document.getElementById('on-page');
  for (var j = 0; j < 25; j++){
    var listItem = document.createElement('li');
    listItem.textContent = 'Total - ' + imageArray[j].clickCount;
